...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-1.png" width="512" height="360"> </td>
  ...
  <tr>
    <td> <img src="/documentation/getting_started/tutorial/images/create-simulation-3.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-4.png" width="512" height="360"> </td>
...
<table class="table table-bordered" style="width:100%">
 ...
 <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-5.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-6.png" width="512" height="360"> </td>
    <td> A <b>Set Inlet/Outlet BCs</b> <i>DialogBox</i> appears.
         <br><br>
         Select the <b>Flow rate (from File) </b> <img src="/documentation/getting_started/tutorial/images/simulation-gui-flow-file.png" width="22" height="20"> icon to bring up a <i>FileBrowser</i>.
         <br><br>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-7.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-8.png" width="512" height="360"> </td>
    <td> A <b>Set Inlet/Outlet BCs</b> <i>DialogBox</i> appears.
        <br><br>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-9.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-10.png" width="512" height="360"> </td>
    <td> A <b>Set Inlet/Outlet BCs</b> <i>DialogBox</i> appears.
        <br><br>
        From the <b>BC Type:</b> <i>ComboBox</i> select <b>Resistance</b>.
        <br><br>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-11.png" width="512" height="360"> </td>
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-14.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-15.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-16.png" width="512" height="360"> </td>
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    ...
    <td> The <i>ToolBox</i> <b>Convert Results</b> page is used to convert <i>svMultiPhysics</i> results files into VTK format files.
         ...
         <br><br>
         <ul style="list-style-type:none;">
           <li> <img src="/documentation/getting_started/tutorial/images/simulation-gui-results-dir.png" width="245" height="32"> - Displays
                the simulation results directory. Use the 
                <img src="/documentation/getting_started/tutorial/images/simulation-gui-flow-file.png" width="22" height="20"> icon to bring up
                a <i>FileBrowser</i> to change the directory.</li><br>
            <li> <img src="/documentation/getting_started/tutorial/images/simulation-gui-start-stop.png" width="245" height="20"> - <i>TextBoxes</i> 
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-18.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-simulation-19.png" width="512" height="360"> </td>
