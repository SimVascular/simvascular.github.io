...
$$
K_{ab}^{ij} = \alpha_{m}\left( \int_{\Omega} \rho N_{a}^{w}N_{b}^{w} \delta_{ij} \,d\Omega + \int_{\Omega} \tau_{SUPS} N_{a,g}^{w} u_{g} \rho N_{b}^{w} \delta_{ij} \,d\Omega - \int_{\Omega} N_{a,k}^{w} \tau_{SUPS}^{2} N_{b}^{w} \delta_{ij} r_{Mk} \,d\Omega \right) + \alpha_{f}\gamma\Delta t \left(\int_{\Omega} \rho N_{a}^{w} u_{k} N_{b, k}^{w} \delta_{ij} \,d\Omega + \int_{\Omega} N_{a, l}^{w} \mu N_{b, l}^{w} \delta_{ij} \,d\Omega + \int_{\Omega} N_{a, j}^{w} \mu N_{b, i}^{w} \,d\Omega \right. + \left. \int_{\Omega} \frac{\mu}{K} N_{a}^{w} N_{b}^{w} \delta_{ij} \,d\Omega + \int_{\Omega} \tau_{SUPS} N_{a,g}^{w} u_{g} \frac{\partial r_{Mi}}{\partial u_{n+\alpha_f,bj}} \,d\Omega + \int_{\Omega} \rho \nu_{LSIC} N_{b,j}^{w} N_{a,i}^{w} \,d\Omega \right. - \left. \int_{\Omega} N_{a}^{w} \tau_{SUPS} N_{b,k}^{w} \delta_{ij} r_{Mk} \,d\Omega - \int_{\Omega} N_{a,k}^{w} \frac{\tau_{SUPS}^{2}}{\rho} \frac{\partial r_{Mi}}{\partial u_{n+\alpha_f,bj}} r_{Mk} \,d\Omega \right. + \left. \int_{\Omega} \frac{4}{\gamma} \frac{\partial \mu}{\partial \gamma} \epsilon_{jk} N_{b,k}^{w} \epsilon_{il} N_{a,l}^{w} \,d\Omega + \int_{\Omega} \frac{\bar{\tau}\tau_{SUPS}^{2}}{\rho} N_{a,k}^{w} N_{b,z}^{w} r_{Mk} r_{Mz} \delta_{ij} \,d\Omega \right),
$$
